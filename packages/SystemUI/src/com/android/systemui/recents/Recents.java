...
public class Recents extends SystemUI implements CommandQueue.Callbacks {
    ...
    public void showRecentApps(boolean triggeredFromAltTab) {
        ...
        if (isOmniSwitchRecents()) {
            FluidUtils.toggleOmniSwitchRecents(mContext, UserHandle.CURRENT);
            return;
        }
    ...
    public void hideRecentApps(boolean triggeredFromAltTab, boolean triggeredFromHomeKey) {
        ...
        if (isOmniSwitchRecents()) {
            FluidUtils.hideOmniSwitchRecents(mContext, UserHandle.CURRENT);
            return;
        }
    ...
    public void preloadRecentApps() {
        ...
        if (isOmniSwitchRecents()) {
            FluidUtils.preloadOmniSwitchRecents(mContext, UserHandle.CURRENT);
            return;
        }
